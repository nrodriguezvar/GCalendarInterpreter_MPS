...
/*package*/ class Color_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.colorCode$q7qP;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no colorCode>");
      editorCell.setCellId("property_colorCode");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty colorCode$q7qP = MetaAdapterFactory.getProperty(0x4a6101dd798a4af7L, 0x9cc1cbdd6558b662L, 0x5ee948073c4bed69L, 0x5ee948073c4bed6aL, "colorCode");
  }
